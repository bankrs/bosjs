...
import StatsTransfersRequest from '../../lib/requests/StatsTransfersRequest'
import User from '../models/User'

@suite
class StatsTransfersRequestTest {
  @test
  'expected endpoint' () {
    assert.strictEqual(this.request.endpoint, '/v1/stats/transfers?from_date=2017-05-30&to_date=2017-05-31')
  }
  ...
  private get request () {
    return new StatsTransfersRequest(new User(), new Date('2017-05-30'), new Date('2017-05-31'))
  }
}
